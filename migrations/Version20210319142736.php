 ...
 */
final class Version20210319142736 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()->getName()===!"mysql","migration only can be executed safely on \"mysql\".");
